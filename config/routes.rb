...
#                       new_user_session GET        /users/sign_in(.:format)                                  welcome#index
#                           user_session POST       /users/sign_in(.:format)                                  devise/sessions#create
#                  new_user_registration GET        /users/sign_up(.:format)                                  welcome#index
#                      user_registration POST       /users/sign_up(.:format)                                  registrations#create
